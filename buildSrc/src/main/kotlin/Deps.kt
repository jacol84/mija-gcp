...
object Libs {
    ...
    object Ktor {
        ...
        private const val ktor_version = "1.5.3"

        const val core = "io.ktor:ktor-server-core:$version"
        const val webjars = "io.ktor:ktor-webjars:$ktor_version"
        const val serverNetty = "io.ktor:ktor-server-netty:$version"
        const val websockets = "io.ktor:ktor-websockets:$ktor_version"
        const val html = "io.ktor:ktor-html-builder:$ktor_version"
        const val gson = "io.ktor:ktor-gson:$ktor_version"
        const val location = "io.ktor:ktor-locations:$ktor_version"
